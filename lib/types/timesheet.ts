...
export type TimesheetEntry = { id: string; employee: string; date: string; project: string; task: string; startTime: string; endTime: string; breakMinutes: number; workedMinutes: number; notes: string; category: EntryCategory; status: ApprovalStatus };
