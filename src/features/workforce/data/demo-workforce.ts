...
export const demoWorkforceTeams: WorkforceTeamView[] = [
  { id:"demo-team-1",name:"Operations",description:"Field delivery and chantier coordination.",leader:"Maya Laurent",memberCount:8,status:"active",currentUserRole:"member" },
