import type { SiteId } from "./site"; import type { CompanyId } from "./company"; import type { ProjectId } from "./project"; import type { EntityId, Timestamp } from "./shared"; import type { UserId } from "./user";
...
export interface TimesheetEntry { id: TimesheetEntryId; timesheetId: TimesheetId; projectId?: ProjectId; siteId?: SiteId; startsAt: Timestamp; endsAt: Timestamp; breakMinutes: number; notes?: string }
